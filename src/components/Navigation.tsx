          ...
          <div className="hidden md:block w-1/3">
            <form action="/wiki" method="get" className="relative">
              <input
                ...
                name="search"
                placeholder="ページを検索..."
                className="w-full py-1.5 pl-3 pr-10 rounded-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-sm"
              />
              <button 
                type="submit" 
